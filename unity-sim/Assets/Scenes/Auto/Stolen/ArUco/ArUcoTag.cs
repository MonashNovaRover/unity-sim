...
public class ArUcoTag : MonoBehaviour
{
    ...
    void OnValidate()
    {
        ...
        Texture2D texture = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Scenes/Auto/Stolen/ArUco/Textures/" + dictInfo[dict].Item1 + "/" + id + ".png");
        Material material = AssetDatabase.LoadAssetAtPath<Material>("Assets/Scenes/Auto/Stolen/ArUco/ArUcoTagCube.mat");
