...
{
    public class ConeMarker : Message
    {
        public const string RosMessageName = "foxglove_msgs/msg/ConeMarker";
        ...
        public ConeMarker(Pose pose, Vector3 size, double bottom_scale, double top_scale, Color color)
        {
            this.pose = pose;
            this.size = size;
