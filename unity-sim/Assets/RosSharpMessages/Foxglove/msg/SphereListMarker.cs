...
{
    public class SphereListMarker : Message
    {
        public const string RosMessageName = "foxglove_msgs/msg/SphereListMarker";
        ...
        public SphereAttributes[] attributes { get; set; }

        public SphereListMarker()
        {
            ...
            this.attributes = new SphereAttributes[0];
        }

        public SphereListMarker(Time timestamp, string frame_id, string id, Duration lifetime, bool frame_locked, KeyValuePair[] metadata, SphereAttributes[] attributes)
        {
