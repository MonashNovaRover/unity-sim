...
{
    public class ConeAttributes : Message
    {
        public const string RosMessageName = "foxglove_msgs/msg/ConeAttributes";
        ...
        public ConeAttributes(Pose pose, Vector3 size, double bottom_scale, double top_scale, Color color)
        {
            this.pose = pose;
            this.size = size;
